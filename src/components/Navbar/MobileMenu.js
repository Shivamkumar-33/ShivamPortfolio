...
const MobileMenu = ({ isOpen, toggle, closeMenu }) => {
  return (
    <MobileMenuContainer isOpen={isOpen} toggle={toggle}>
      ...
      <MobileMenuList>
        <MobileMenuLink to="home" onClick={closeMenu} aria-label="Go to Home section">
          Home
        </MobileMenuLink>
        <MobileMenuLink to="projects" onClick={closeMenu} aria-label="View my Projects">
          Projects
        </MobileMenuLink>
        <MobileMenuLink to="about" onClick={closeMenu} aria-label="Learn About me">
          About
        </MobileMenuLink>
